...
:Author: Kevin Huang, Georg von der Brueggen and Kuan-Hsun Chen (kuan-hsun.chen@tu-dortmund.de)
:Date: 03.09.19
...
def CSet_generate_uniform(Pmin, Pmax):
    global USet,PSet
    for i in USet:
...
def taskGeneration_p(numTasks,uTotal):
    ...
    CSet_generate(1,2) # modified by Lea for testing purposes
    # CSet_generate_uniform(1,2)
    return PSet
